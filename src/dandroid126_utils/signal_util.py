...
class SignalUtil:
    ...
    def __init__(self, logger: Logger, cleanup_timeout: Optional[float] = None):
        """
    ...
    def interrupt(self, *args):
        ...
        self.logger.i(TAG, f"interrupt(): interrupted. args: {args}")
        ...
        if self.cleanup_timeout is not None:
            self.logger.i(TAG, f"interrupt(): waiting so the program can clean up.")
